...
@SourceType(value = "SmaregiARP", label = "Smaregi",uiConfig = "smaregi-layout.json")
public class SmaregiConf extends AbstractArpConf<SmaregiConf> {
  private static final String ARP_FILENAME = "arp/implementation/smaregi-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.smaregi.SmaregiDriver";
